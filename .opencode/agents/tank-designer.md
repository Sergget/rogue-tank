...
2. **Tank structure**: `pivot` (turret ring center on hull), `axis` (turret's own rotation center — always normalized to 0,0 on export), `traverseLimit` (0-360° traverse range for fixed-turret tanks)
