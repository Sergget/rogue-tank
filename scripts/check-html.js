...
for (const scriptFile of ['scripts/test-covers.js', 'scripts/test-tanks.js', 'scripts/test-hitpart.js', 'scripts/test-tankcollision.js', 'scripts/test-nodegen.js', 'scripts/test-camera.js', 'scripts/test-map.js', 'scripts/test-flow.js', 'scripts/test-ai.js', 'scripts/test-revive.js', 'scripts/test-cards.js', 'scripts/test-boss.js', 'scripts/validate-content.js', 'scripts/audit-content.js', 'scripts/test-extreme-combat.js', 'scripts/test-extreme-geometry.js', 'scripts/test-extreme-model.js', 'scripts/test-extreme-cover.js', 'scripts/test-assets.js', 'scripts/test-audio.js']) {
